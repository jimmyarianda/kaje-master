    ...
    public function get_data()
    {
        if (!$this->input->is_ajax_request()) {
            ...
            $columns = array(
                ...
                array('db' => 'h_picbanner', 'dt' => 'h_picbanner'),
                array(
                    'db' => 'h_id',
                    'dt' => 'action',
                    'formatter' => function ($id) {
                        return '<a href="' . site_url('d_home/edit/' . $id) . '" class="btn btn-success btn-sm mb-1"><i class="fa fa-edit"></i>Edit</a>
    ...
    public function edit()
    {
        ...
        if (isset($_POST['simpan'])) {
            ...
            $data = [
                ...
                // 'h_picbanner' => $data['home']['h_picbanner']
            ];

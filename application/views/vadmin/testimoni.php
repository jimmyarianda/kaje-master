            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">Tambah Data
                        &nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-sm" href="<?= site_url('d_testimoni/add'); ?>"><i class="fa fa-plus">&nbsp;&nbsp;</i>Tambah Data</a>
                    </div>
                    <div class="card-body">
                        <!-- <div class="col-12"> -->
                            <div class="table-responsive">
                                <table id="ttestimoni" class="table table-bordered table-hover" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>id_testimoni</th>

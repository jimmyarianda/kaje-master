...
<div class="col-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <?php echo form_open_multipart('d_home/add'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="text3" class="form-control" placeholder="Inputkan Text" required>
            </div>
            <div class="form-group">
                <label>Banner</label>
                <input type="file" name="picbanner" class="form-control" required>
            </div>

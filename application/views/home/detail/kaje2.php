        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="single-content wow fadeInUp">
                    <img src="<?= site_url() ?>assets/assets_home/img/<?= $berita['foto']?>" />
                ...
                <div class="post-item">
                                <div class="post-img">
                                    <img src="<?= site_url() ?>assets/assets_home/img/logo.png" />
                                </div>
                                <div class="post-text">
                                    <a><?= $berita['perusahaan']; ?></a>
                                    <div class="post-meta">
                                        <p>Publisher<a><?= $berita['user']; ?></a></p>
                                        <p><a><?= $berita['created_at']; ?></a></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="sidebar-widget wow fadeInUp">
                        ...
                        <?php foreach ($terbaru as $row) { ?>
                            <div class="post-item">
                                ...
                                <div class="post-text">
                                    <a href="<?= site_url('h_berita/detail/')?><?= $row['id_berita']; ?>"><?= $row['judul_berita']?></a>
                                    <div class="post-meta">
                    ...
                    <div class="sidebar-widget wow fadeInUp">
                        ...
                        <div class="category-widget">
                            ...
                            <?php foreach ($kategori1 as $row) { ?>
                                <li><a href="<?= site_url('h_produk/detail/')?><?= $row['id_kategori']; ?>"><?= $row['nama_kategori']; ?></a><span></span></li>
